    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">View Reply</h4>
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                     <c:forEach var="i" items="${admincomplainlist}" varStatus="j" >
						<tr>
							<td>${j.count}</td>
							...
							<td>${i.reply}</td>
							<td>${i.replyTime}</td>
							<td><a href="<%=request.getContextPath()%>/document/complain/${i.filepathName}">View</a></td>			
							<td>
							<c:if test="${i.complainStatus eq 'Resolved'}">
								<a class="btn btn-outline-primary">Resolved</a>
							</c:if>
							<c:if test="${i.complainStatus eq 'pending'}">
								<a href="reply?id=${i.id}"><i class="mdi mdi-message-reply-text menu-icon"></i></a>
							</c:if>

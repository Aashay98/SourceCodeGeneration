                    ...
                    <table id="order-listing" class="table">
                     ...
                     <c:forEach var="i" items="${feedbacklist}" varStatus="j" >
						<tr>
							...
							<td>${i.feedback}</td>
							<td>
								<c:forEach var="k" begin="1" end="${i.rating}">
								<div class="rating">
									<input type="radio" id="star1" value="${k}" ><label for="star5" ><span class="fa fa-star checked"></span></label>
								</div>
    							</c:forEach>
							</td>
							<td>
                              <a href="deleteUserFeedback?id=${i.id}" ><i class="mdi mdi-delete menu-icon"></i></a>
                              <a href="updateUserFeedback?id=${i.id}" style="magin:60px"><i class="mdi mdi-marker menu-icon"></i></a>
                            </td>
						</tr>
					 </c:forEach>

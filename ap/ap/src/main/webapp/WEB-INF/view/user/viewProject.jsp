                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                     <c:forEach var="i" items="${projectlist}" varStatus="j" >
						<tr>
							<td>${j.count}</td>
							<td>${i.projectName}</td>
							<td>${i.moduleName}</td>
							...
							<td>${i.fieldType}</td>
							<td>
                              <a href="deleteUserProject?projectId=${i.projectId}" class="btn btn-outline-primary"><i class="mdi mdi-delete menu-icon"></i></a>
                            </td>
						</tr>
					 </c:forEach>
